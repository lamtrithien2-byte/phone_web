...
public class ProfileController {
    ...
    public String updateProfile(@RequestParam String fullName,
        ...
        try {
            ...
            bind(model, SessionSupport.getCurrentUser(session), "Đã cập nhật hồ sơ.", null);
        } catch (RestClientException ex) {
            bind(model, currentUser, null, "Hệ thống xử lý dữ liệu đang tạm thời không phản hồi.");
        }
        return "profile";
    }
