...
- CMS: `http://localhost:8082/login`
- Shop: `http://localhost:8083/`
- API product: `http://localhost:8081/api/products`
- API order: `http://localhost:8081/api/orders/by-phone?phoneNumber=0901111111`
- API chat: `http://localhost:8081/api/chat`
